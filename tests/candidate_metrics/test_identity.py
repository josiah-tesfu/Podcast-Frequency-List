...
def test_candidate_metrics_service_refreshes_unit_identity_metrics(tmp_path) -> None:
    ...
    rare_information = _information_content(observed_frequency=1, total_tokens=12)
    common_information = _information_content(observed_frequency=2, total_tokens=12)
...
def test_candidate_metrics_service_keeps_one_gram_unit_identity_metrics_null(tmp_path) -> None:
    ...
    assert first_row == (None, None, None, None, None, None, None)
